...
func (h *Handler) handleSimpleAction(w http.ResponseWriter, r *http.Request, action func(ctx context.Context, contentItemID string) error, successMsg string) {
