...
func New(contentRepo contentdomain.ContentRepository, transactor contentdomain.Transactor) *Service {
	return &Service{contentRepo: contentRepo, transactor: transactor}
}
