...
func TestDeleteArticle(t *testing.T) {
	Convey("DELETE /api/v1/admin/articles/{id}", t, func() {
		var svcErr error
		...
		f := newHTTPFixture(svc, http.MethodDelete, "/api/v1/admin/articles/11111111-1111-1111-1111-111111111111")
		...
		Convey("Valid request → 200 with message", func() {
			...
			So(body["message"], ShouldEqual, "article was successfully deleted")
		})
		...
		Convey("invalid ArticleID", func() {
			f := newHTTPFixture(svc, http.MethodDelete, "/api/v1/admin/articles/---")
			mux, newReq := f.mux, f.newReq
