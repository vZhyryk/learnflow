...
func (m *mockReviewRepo) DeleteCourseReview(ctx context.Context, reviewID string) error {
...
func (m *mockReviewRepo) DeleteContentReview(ctx context.Context, reviewID string) error {
